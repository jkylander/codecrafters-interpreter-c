...
int utest_main(int argc, const char *const argv[]) {
  ...
  // INFO: Hack to get around this unexplicable error
  // tests\utest.h:1442:27: error: use of undeclared identifier '_isatty'
  //  1442 |   const int use_colours = UTEST_COLOUR_OUTPUT();
  //       |                           ^
  // tests\utest.h:309:32: note: expanded from macro 'UTEST_COLOUR_OUTPUT'
